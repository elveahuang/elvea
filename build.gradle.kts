...
allprojects {
    ...
    dependencyManagement {
        imports {
            ...
            mavenBom("io.modelcontextprotocol.sdk:mcp-bom:0.7.0")
            mavenBom("cn.hutool:hutool-bom:5.8.35")
            mavenBom("me.ahoo.cosid:cosid-bom:2.11.0")
            mavenBom("org.mockito:mockito-bom:5.14.2")
            mavenBom("io.netty:netty-bom:4.1.117.Final")
            mavenBom("org.apache.groovy:groovy-bom:4.0.25")
        ...
        dependencies {
            ...
            dependency("org.springdoc:springdoc-openapi-starter-common:2.8.5")
            dependency("org.springdoc:springdoc-openapi-starter-webmvc-ui:2.8.5")
            dependency("org.springdoc:springdoc-openapi-starter-webflux-ui:2.8.5")
            // database & nosql
            ...
            dependency("com.nimbusds:oauth2-oidc-sdk:11.22.2")
            ...
            dependency("com.github.oshi:oshi-core-java11:6.6.6")
            ...
            dependency("net.bytebuddy:byte-buddy:1.17.1")
            dependency("net.bytebuddy:byte-buddy-agent:1.17.1")
            ...
            dependency("com.alibaba:fastjson:2.0.55")
            ...
            dependency("org.dromara:x-easypdf-pdfbox:3.3.0")
            dependency("org.jsoup:jsoup:1.18.3")
            // sdk
            dependency("io.minio:minio:8.5.17")
            dependency("com.larksuite.oapi:oapi-sdk:2.4.9")
            ...
            dependency("org.telegram:telegrambots:6.9.7.1")
            // sdk - ai
            dependency("com.openai:openai-java:0.22.0")
            // sdk - aliyun
            dependency("com.aliyun:dingtalk:2.1.92")
            ...
            dependency("com.alibaba:dashscope-sdk-java:2.18.2")
            dependency("com.aliyun:aliyun-java-sdk-core:4.7.3")
            dependency("com.alipay.sdk:alipay-sdk-java:4.40.54.ALL")
            // sdk - tencent
            dependency("com.qcloud:cos_api:5.6.242")
            dependency("com.tencentcloudapi:tencentcloud-sdk-java-common:3.1.1198")
            ...
            dependency("com.tencentcloudapi:tencentcloud-sdk-java-hunyuan:3.1.1197")
            // commons
